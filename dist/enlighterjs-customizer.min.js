...
var EnlighterJS_Customizer = (function (exports) {
    ...
    // global _ruleset
    // selector => [] rules
    var _ruleset = {}; // retrieve global _ruleset
    ...
    function triggerUpdate(selector, component) {
      // update rules for specific component
      updateRules(selector, component.getRules()); // call hooks
    ...
    function loadBaseTheme(theme) {
      // theme exists ?
      if (!baseThemes[theme]) {
        throw new Error("base theme ".concat(theme, " doesn't exist"));
      } // get styles


      var rulesets = baseThemes[theme]; // iterate over components
    ...
    function () {
      function Component(props) {
        ...
        this.el = null;
        this.value = null;
        this.cssProperty = null; // register component
    ...
    function init() {
      ...
      try {
        ...
        parseRemoteStylesheet(options.themeURL, function (err, rulesets) {
          ...
          console.log(rulesets); // register base themes

          registerBaseThemes(rulesets); // render settings

          renderComponent(new SettingsView().render(), getElement(options.settings)); // render font settings
